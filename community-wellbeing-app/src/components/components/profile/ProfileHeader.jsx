...
export default function ProfileHeader({ user, isFromSearch = false}) {
      ...
      <div className="card">
        <div className="flex flex-col md:flex-row items-start gap-6">
          ...
          <div className="flex-1 w-full">
            ...
            {/* Only show email, location, age if NOT from search */}
            {!isFromSearch && (
            ...
            {/* Level Progress - Only show if NOT from search */}
            {!isFromSearch && (
              <div>
